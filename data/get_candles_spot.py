...
MARKETS = ['BTCUSDT', 'ETHBTC', 'EOSBTC', 'LTCBTC', 'BNBBTC', 'XRPBTC', 'BCHBTC', 'ADABTC', 'XMRBTC', 'FTTBTC','LINKBTC', 'XLMBTC','DOGEBTC','ALGOBTC','ATOMBTC','TRXBTC','XEMBTC','IOTABTC','VETBTC', 'ETHUSDT', 'EOSUSDT', 'LTCUSDT', 'BNBUSDT', 'XRPUSDT', 'BCHUSDT', 'ADAUSDT', 'XMRUSDT', 'LINKUSDT', 'XLMUSDT','DOGEUSDT','ALGOUSDT','ATOMUSDT','TRXUSDT','XEMUSDT','IOTAUSDT','VETUSDT']
