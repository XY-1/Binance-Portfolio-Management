...
MARKETS  = ['BTCUSDT', 'ETHUSDT', 'EOSUSDT', 'FTTUSDT', 'BNBUSDT', 'LTCUSDT', 'BCHUSDT', 'ADAUSDT', 'XRPUSDT', 'LSKUSDT', 'FCTUSDT', 'XEMUSDT', 'MONAUSDT', 'XLMUSDT', 'QTMUUSDT', 'BATUSDT', 'IOSTUSDT', 'ENJUSDT', 'DOGEUSDT', 'DOTUSDT', 'LINKUSDT', 'ATOMUSDT', 'TRXUSDT', 'IOTA' ,'VETUSDT', 'XTZUSDT', 'THETAUSDT', 'NEOUSDT', 'FTTUSDT', 'MKRUSDT', 'DASHUSDT', 'ETCUSDT', 'ZRXUSDT', 'DCRUSDT', 'ZILUSDT', 'WAVES' ,'SCUSDT', 'AEUSDT', 'MANAUSDT','NANOUSDT','ONTUSDT','ZECUSDT','DGBUSDT','OMGUSDT','HBARUSDT','ICXUSDT','ZENUSDT','KNCUSDT','BNTUSDT','RVNUSDT','OCEANUSDT','MATICUSDT']
